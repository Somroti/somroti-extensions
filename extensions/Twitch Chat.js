(function(Scratch) {
    ...
    class twitchChat {
        ...
        joinChannel(args) {
            ...
            if (isConnecting) {
                return 'Already trying to connect. Please wait.';
            }
    ...
    Scratch.extensions.register(new twitchChat());
})(Scratch);
